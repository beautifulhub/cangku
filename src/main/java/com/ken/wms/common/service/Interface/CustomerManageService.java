...
public interface CustomerManageService {
     ...
     * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
     */
    Map<String, Object> selectByName(int offset, int limit, String customerName,Integer repoID) throws CustomerManageServiceException;
     ...
     * @param offset       分页的偏移值
     * @param limit        分页的大小
     * @param principal 客户负责人
     * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
     */
    Map<String, Object> selectByPrincipal(int offset, int limit,String principal,Integer repoID) throws CustomerManageServiceException;
     ...
     * @return 结果的一个Map，其中： key为 data 的代表记录数据；key 为 total 代表结果记录的数量
     */
    Map<String, Object> selectAll(int offset, int limit,Integer repoID) throws CustomerManageServiceException;
     ...
     */
    Map<String, Object> importCustomer(MultipartFile file,Integer repoID) throws CustomerManageServiceException;
